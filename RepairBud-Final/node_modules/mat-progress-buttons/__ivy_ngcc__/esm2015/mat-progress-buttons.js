...
function MatSpinnerButtonComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("is-mat-icon", !ctx_r123.options.buttonIcon.fontSet)("active", ctx_r123.options.active && !ctx_r123.options.disabled);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r123.options.buttonIcon.customClass)("fontSet", ctx_r123.options.buttonIcon.fontSet)("fontIcon", ctx_r123.options.buttonIcon.fontIcon)("color", ctx_r123.options.buttonIcon.color)("svgIcon", ctx_r123.options.buttonIcon.svgIcon)("inline", ctx_r123.options.buttonIcon.inline);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r123.options.buttonIcon.fontSet ? "" : ctx_r123.options.buttonIcon.fontIcon, " ");
} }
function MatSpinnerButtonComponent_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("active", ctx_r124.options.active && !ctx_r124.options.disabled);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r124.options.text, " ");
} }
function MatSpinnerButtonComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("fontSet", ctx_r125.options.icon.fontSet)("fontIcon", ctx_r125.options.icon.fontIcon)("color", ctx_r125.options.icon.color)("svgIcon", ctx_r125.options.icon.svgIcon)("inline", ctx_r125.options.icon.inline);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r125.options.icon.fontSet ? "" : ctx_r125.options.icon.fontIcon, " ");
} }
function MatSpinnerButtonComponent_mat_spinner_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("active", ctx_r126.options.active && !ctx_r126.options.disabled);
    ɵngcc0.ɵɵproperty("diameter", ctx_r126.options.fab ? 58 : ctx_r126.options.spinnerSize)("color", ctx_r126.options.spinnerColor)("mode", ctx_r126.options.mode)("value", ctx_r126.options.value);
} }
function MatBarButtonComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("is-mat-icon", !ctx_r127.options.buttonIcon.fontSet);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r127.options.buttonIcon.customClass)("fontSet", ctx_r127.options.buttonIcon.fontSet)("fontIcon", ctx_r127.options.buttonIcon.fontIcon)("color", ctx_r127.options.buttonIcon.color)("svgIcon", ctx_r127.options.buttonIcon.svgIcon)("inline", ctx_r127.options.buttonIcon.inline);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r127.options.buttonIcon.fontSet ? "" : ctx_r127.options.buttonIcon.fontIcon, " ");
} }
function MatBarButtonComponent_mat_progress_bar_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("color", ctx_r128.options.barColor)("mode", ctx_r128.options.mode)("value", ctx_r128.options.value);
} }
